		<div id="page-wrapper">		 
            <div class="row">
               <div class="col-lg-12">
				...
				<div class="col-lg-12">
					<a href="<?php echo base_url()?>admin/merk/tambah">
								...
								<table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="<?php echo base_url()?>admin/merk/ubah/<?php echo $row->id_merk;?>">Update</a> 
												<?php 
												if($this->session->userdata('level') == 'admin')
												{	
													?>
													| <a href="<?php echo base_url();?>admin/merk/delete/<?php echo $row->id_merk;?>">Delete</a></td>
													<?php 
												}
												?> 
										</tr>
