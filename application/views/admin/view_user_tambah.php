							...
							<div class="dataTable_wrapper">
								  <form action="<?php echo base_url()?>admin/user/insert" method="POST" enctype="multipart/form-data" > 
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" type="text" size="20" id="username" name="username"  value="" class="input-xlarge"/>
                                        </div>
										<div class="form-group">
                                            <label>Password</label>
                                            <input class="form-control" type="password" size="20" id="password" name="password"  value="" class="input-xlarge"/>
                                        </div> 
                                        <div class="form-group">
