		<div id="page-wrapper">		 
            <div class="row">
               <div class="col-lg-12">
                    <h1 class="page-header">Tambah Jenis</h1>
                </div> 
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								  <form action="<?php echo base_url()?>admin/jenis/insert" method="POST" enctype="multipart/form-data" > 
                                         
										 
										<div class="form-group">
                                            <label>Nama jenis</label>
                                            <input class="form-control" type="text" size="20" id="nama_jenis" name="nama_jenis"  value="" class="input-xlarge"/>
                                        </div> 
                                        <div class="form-group">
