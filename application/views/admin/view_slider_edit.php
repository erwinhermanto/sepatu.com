						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								  ...
								  <?php foreach ($data as $row): ?>
										<input class="form-control" size="10" id="id" name="id" type="hidden" value="<?php echo $row->id_slider;?>" class="input-xlarge"/>
                                         
										<div class="form-group">
                                            <label>Nama slider</label>
                                            <input class="form-control" type="text" size="20" id="nama_slider" name="nama_slider"  value="<?php echo $row->nama_slider;?>" class="input-xlarge"/>
                                        </div>
