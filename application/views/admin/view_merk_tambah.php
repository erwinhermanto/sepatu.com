					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="dataTable_wrapper">
								  <form action="<?php echo base_url()?>admin/merk/insert" method="POST" enctype="multipart/form-data" > 
                                         
										 
										<div class="form-group">
                                            <label>Nama merk</label>
                                            <input class="form-control" type="text" size="20" id="nama_merk" name="nama_merk"  value="" class="input-xlarge"/>
                                        </div> 
                                        <div class="form-group">
